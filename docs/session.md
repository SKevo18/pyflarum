Module pyflarum.session
=======================

Classes
-------

`FlarumSession(forum_url: str, username_or_email: Optional[str] = None, password: Optional[str] = None, api_endpoint: str = 'api', user_agent: str = 'pyflarum', session_object: Session | Any = <requests.sessions.Session object>)`
