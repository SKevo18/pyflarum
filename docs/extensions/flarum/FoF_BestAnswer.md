Module pyflarum.extensions.flarum.FoF_BestAnswer
================================================

Classes
-------

`BestAnswerDiscussionMixin(user: FlarumUser, _fetched_data: dict)`
...
`BestAnswerDiscussionNotificationMixin(user: FlarumUser, _fetched_data: dict)`
:   A discussion from `Notification`. Contains the least
    ...
    * builtins.dict
    ...
    `bestAnswerSetAt: Optional[datetime.datetime]`
    :
