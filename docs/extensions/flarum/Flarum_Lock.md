Module pyflarum.extensions.flarum.Flarum_Lock
=============================================

Classes
-------

`LockDiscussionFromBulkMixin(user: FlarumUser, _fetched_data: dict)`
:   A discussion from `Discussions`.
    ...
    * builtins.dict
    ...
    `lock(self) ‑> pyflarum.flarum.core.discussions.Discussion`
    ...
    `unlock(self) ‑> pyflarum.flarum.core.discussions.Discussion`
    :   Unlocks the discussion.

`LockDiscussionFromNotificationMixin(user: FlarumUser, _fetched_data: dict)`
