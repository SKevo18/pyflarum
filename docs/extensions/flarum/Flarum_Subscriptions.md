Module pyflarum.extensions.flarum.Flarum_Subscriptions
======================================================

Classes
-------

`SubscriptionsDiscussionFromBulkMixin(user: FlarumUser, _fetched_data: dict)`
:   A discussion from `Discussions`.
    ...
    * builtins.dict
    ...
    `subscription: Optional[Literal['following', 'ignoring']]`
...
`SubscriptionsDiscussionFromNotificationMixin(user: FlarumUser, _fetched_data: dict)`
