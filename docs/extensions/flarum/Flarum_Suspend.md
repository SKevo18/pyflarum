Module pyflarum.extensions.flarum.Flarum_Suspend
================================================
...
`SuspendUserMixin(user: FlarumUser, _fetched_data: dict)`
:   An user from `Users`.
    ...
    * builtins.dict
    ...
    `suspend(self, suspended_until: Optional[datetime.datetime] = None, suspended_for: Optional[datetime.timedelta] = None) ‑> pyflarum.flarum.core.users.User`
    :