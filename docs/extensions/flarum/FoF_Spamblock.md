Module pyflarum.extensions.flarum.FoF_Spamblock
===============================================
...
`SpamblockUserFromNotificationMixin(user: FlarumUser, _fetched_data: dict)`
...
`SpamblockUserMixin(user: FlarumUser, _fetched_data: dict)`
:   An user from `Users`.
