Module pyflarum.extensions.flarum.Flarum_Sticky
===============================================

Classes
-------

`StickyDiscussionFromBulkMixin(user: FlarumUser, _fetched_data: dict)`
...
`StickyDiscussionFromNotificationMixin(user: FlarumUser, _fetched_data: dict)`
:   A discussion from `Notification`. Contains the least
    ...
    * builtins.dict
    ...
    `stick(self) ‑> pyflarum.flarum.core.discussions.Discussion`
    ...
    `unstick(self) ‑> pyflarum.flarum.core.discussions.Discussion`
