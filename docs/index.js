...
"ref":"pyflarum",
"url":0,
"doc":"pyFlarum Python package - provides an easy access to Flarum's API. (c) Kevo 2021 You are allowed to modify any parts of this program, as long as this notice stays on its place, without any modifications. It is that simple to support my hard work. Thank you for using this. - PyPi: https: pypi.org/project/pyFlarum/ - Official Flarum website: https: flarum.org"
},
{
...
"url":5,
"doc":"dict() -> new empty dictionary dict(mapping) -> new dictionary initialized from a mapping object's (key, value) pairs dict(iterable) -> new dictionary initialized as if via: d = {} for k, v in iterable: d[k] = v dict( kwargs) -> new dictionary initialized with the name=value pairs in the keyword argument list. For example: dict(one=1, two=2) Initializes the session."
},
{
...
"url":6,
"doc":"Simple, hardcoded  'key: value'  dict of API routes. API routes reference (old): https: github.com/flarum/flarum.github.io/blob/20322c0e6011e4f304ae7e95f41594a0b086bc27/_docs/api.md"
},
{
